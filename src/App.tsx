...
import SitemapPage from "./pages/Sitemap";
import NotFound from "./pages/NotFound";
import CityPage from "./pages/CityPage"; // The new dynamic component
        ...
        <BrowserRouter>
          <Routes>
            ...
            {/* SEO CITY LANDING PAGES 
              The :citySlug parameter handles /animation-courses-hyderabad, 
              /animation-courses-mysore, etc., in one single route.
            */}
            <Route path="/animation-courses-:citySlug" element={<CityPage />} />
