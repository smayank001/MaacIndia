...
const benefits = [
  {
    ...
    desc: "Leverage 25+ years of brand equity and nationwide recognition.",
  },
  {
    icon: TrendingUp,
    title: "High ROI",
    desc: "Proven business model with strong returns on investment.",
  },
  {
    icon: Users,
    title: "Training & Support",
    desc: "Complete operational training and ongoing business support.",
  },
  {
    icon: Shield,
    title: "Proven Curriculum",
    desc: "Industry-recognized courses with high employability outcomes.",
  },
];
...
const faqs = [
  {
    ...
    a: "The investment varies based on location and centre size. Contact us for a detailed breakdown tailored to your city.",
  },
  {
    q: "What kind of support does MAAC provide?",
    a: "We provide comprehensive support including training, marketing, curriculum, software licenses, placement assistance, and operational guidance.",
  },
  {
    q: "Do I need a background in education?",
    a: "No prior education background is required. We provide complete training on all operational and academic aspects.",
  },
  {
    q: "How long does it take to set up a centre?",
    a: "A typical MAAC centre can be set up within 60-90 days from agreement signing.",
  },
  {
    q: "What is the franchise territory?",
    a: "Each franchise partner gets an exclusive territory to operate, ensuring no competition from other MAAC centres.",
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        <ScrollReveal>
          ...
          <p className="text-muted-foreground text-lg max-w-2xl">
            Join India's largest creative education network. Own a MAAC
            franchise and empower the next generation of creative professionals.
          </p>
        </ScrollReveal>
      </div>
    </section>
