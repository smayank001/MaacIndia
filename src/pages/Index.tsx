...
const courses = [
  {
    ...
    desc: "Master storytelling through animation, modeling, texturing, lighting, and rigging",
  },
  {
  ...
  },
  {
    ...
    desc: "Learn game asset creation, real-time rendering, and interactive design",
  },
  {
    title: "VFX Courses",
    image: "/images/courses/vfx.webp",
    path: "/courses/visual-effects",
    desc: "Advanced CGI, compositing, and motion tracking for film & TV",
  },
  {
    title: "Motion Graphics & Broadcast",
    image: "/images/courses/motion-graphics.webp",
    path: "/courses/broadcast",
    desc: "Motion design, video editing, and broadcast graphics",
  },
  {
    title: "Skill Enhancement",
    image: "/images/courses/skill-enhancement.webp",
    path: "/courses/skill-enhancement",
    desc: "Specialized short-term courses in animation, VFX, game design, and more",
  },
];
...
const whyChoose = [
  ...
  },
  {
    ...
    desc: "Pan-India placement cell with 85%+ placement rate",
  },
  {
    icon: Zap,
  ...
  <Layout>
    ...
    <section className="relative h-[100vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
        ...
        >
          <p className="text-accent font-semibold text-sm md:text-base tracking-[0.3em] uppercase mb-4">
            MAAC Yelahanka, Bangalore
          </p>
        </motion.div>
        <motion.h1
        ...
        >
          CREATE THE
          <br />
          <span className="text-gradient-gold">FUTURE</span> OF
          <br />
          ENTERTAINMENT
        </motion.h1>
        <motion.p
        ...
        >
          Master Animation, VFX, Gaming, Filmmaking & Digital Content at
          Bangalore's most awarded creative institute. Students from across
          India welcome — relocation support available.
        </motion.p>
        <motion.div
        ...
        >
          <Link
            to="/courses"
            className="px-8 py-4 bg-accent text-accent-foreground font-semibold rounded-lg glow-gold hover:brightness-110 transition-all duration-300 text-sm tracking-wide uppercase"
          >
            Explore Courses
          </Link>
          <Link
          ...
          <div className="flex items-center justify-between mb-12 flex-wrap gap-4">
            <div>
              ...
              <p className="text-muted-foreground mt-2 max-w-xl">
                See how MAAC Yelahanka students are raising the bar with
                projects that blend skill, vision, and real-world training.
              </p>
            </div>
            <Link
              to="/students/gallery"
              className="inline-flex items-center gap-2 px-6 py-3 glass text-accent font-semibold rounded-lg hover-glow text-sm tracking-wide uppercase"
            >
      ...
      <div className="max-w-4xl mx-auto text-center">
        <ScrollReveal>
          ...
          <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
            Career guidance, industry trends, and student success stories from
            the world of animation, VFX, and gaming.
          </p>
          <Link
            to="/blog"
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        <ScrollReveal>
          ...
          <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
            ...
            with MAAC Yelahanka. Students from across India welcome.
          </p>
