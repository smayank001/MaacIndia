      ...
      <section className="relative h-[100vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
          ...
          >
            ...
            India's most awarded creative institute.
          </motion.p>
          <motion.div
          ...
          >
            <div
              onClick={() => handleProgramClick("/courses")}
              className="px-8 py-4 bg-primary text-primary-foreground font-semibold rounded-lg glow-red hover:brightness-110 transition-all duration-300 text-sm tracking-wide uppercase cursor-pointer inline-block"
            >
              Explore Courses
            </div>
            <Link
        ...
        <div className="max-w-7xl mx-auto px-4 space-y-6">
          {heroBanners.slice(0, 3).map((banner, i) => (
            <ScrollReveal key={i}>
              <div
                onClick={() => handleProgramClick("/courses")}
                className="block rounded-xl overflow-hidden hover-glow cursor-pointer"
              >
                <img
                  src={banner.img}
                  alt={banner.alt}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {courses.map((course, i) => (
              <ScrollReveal key={course.title} delay={i * 0.1}>
                <div
                  onClick={(e) => handleProgramClick(course.path, e)}
                  className="group block relative rounded-xl overflow-hidden aspect-[4/5] hover-glow cursor-pointer"
                >
                  <img
                    src={course.image}
                    alt={course.title}
        ...
        <div className="max-w-7xl mx-auto">
          <ScrollReveal>
            ...
            <p className="text-muted-foreground max-w-2xl mb-10">
              From national-level competitions to industry-recognized awards,
              our students consistently push the boundaries of creative
              excellence.
            </p>
          </ScrollReveal>
