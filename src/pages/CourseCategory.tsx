...
const CourseCategory = () => {
  ...
  useEffect(() => {
    if (category) {
      document.title = `${category.title} Courses - MAAC India`;
      const meta = document.querySelector('meta[name="description"]');
      if (meta) meta.setAttribute("content", category.heroDesc);
    }
  }, [category]);
  ...
  return (
    <Layout>
                    ...
                    <div className="p-5 sm:p-6 flex flex-col justify-center">
                      ...
                      {course.duration && (
                        <p className="text-xs text-muted-foreground mb-1">
                          Duration: {course.duration} | Eligibility:{" "}
                          {course.eligibility}
                        </p>
                      )}
        ...
        <div className="max-w-7xl mx-auto">
          <ScrollReveal>
            ...
            <p className="text-muted-foreground mb-8">
              After completing any of these courses, you can work as
            </p>
          </ScrollReveal>
            ...
            {category.careerRoles.map((role, i) => (
              <ScrollReveal key={role.title} delay={i * 0.08}>
                <div className="glass rounded-xl overflow-hidden hover-glow group">
                  ...
                  <p className="p-3 text-sm font-medium text-foreground text-center">
                    {role.title}
                  </p>
                </div>
              </ScrollReveal>
      ...
      <section className="relative py-20 overflow-hidden">
        <img
          src="/images/courses/banners/vfx-join.jpg"
          alt="Join MAAC"
          className="absolute inset-0 w-full h-full object-cover"
        />
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4">
          <ScrollReveal>
            <h2 className="font-display text-4xl md:text-6xl text-foreground mb-4">
              WANT TO JOIN AFTER 12TH?
            </h2>
            <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
              Your search ends here! MAAC offers job-oriented programs that help
              you master {category.title} and prepare you for a successful
      ...
      <section className="section-padding pt-0">
        <div className="max-w-4xl mx-auto text-center">
          <ScrollReveal>
            ...
            <p className="text-muted-foreground mb-8">
              Join MAAC's {category.title} courses and turn your creativity into
              a thriving career.
            </p>
            <Link
              to="/contact"
