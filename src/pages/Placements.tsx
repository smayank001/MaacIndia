      ...
      <div className="max-w-7xl mx-auto">
        <ScrollReveal>
          ...
          <h1 className="font-display text-5xl md:text-8xl text-foreground mb-4">
            YOUR LAUNCHPAD TO THE INDUSTRY
          </h1>
          <p className="text-muted-foreground text-lg max-w-2xl mb-8">
            You don't just train here — you get ready to lead. You get hired
            because you're ready from Day 1, with real skills and
        ...
        <ScrollReveal>
          <div className="relative rounded-xl overflow-hidden aspect-[21/9] mb-8">
            <img
              src="/images/about/young-learners.jpg"
              alt="Enthusiastic Students at MAAC"
    ...
    <section className="py-6 overflow-hidden">
      <div className="flex animate-marquee whitespace-nowrap gap-6">
        {[...hiringPartners, ...hiringPartners].map((p, i) => (
          <span
            key={i}
            className="glass rounded-lg px-6 py-3 font-display text-base text-foreground tracking-wider shrink-0"
          >
            {p}
          </span>
        ))}
          ...
          {hiringPartners.map((p, i) => (
            <ScrollReveal key={`${p}-${i}`} delay={(i % 12) * 0.04}>
              <div className="glass rounded-lg px-5 py-3 hover-glow">
                <span className="font-display text-base text-foreground tracking-wider">
                  {p}
                </span>
              </div>
            </ScrollReveal>
